...
const ProductCard: React.FC<{ product: Product }> = ({ product }) => {
  return (
    <Link href={`/shop/product/${product.id}`}>
      <div className="group border-accent relative z-0 flex max-h-80 w-64 flex-col items-center justify-start overflow-hidden rounded-2xl border bg-white p-3 shadow-md transition duration-200 ease-in-out hover:-translate-y-1 hover:cursor-pointer hover:shadow-lg">
